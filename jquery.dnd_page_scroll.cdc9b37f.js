...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"javascript/lib/jquery.dnd_page_scroll.js":[function(require,module,exports) {
(function ($) {
  ...
  $.fn.dndPageScroll = function (options) {
    ...
    if (!top_el.length) top_el = $('<div id="top_scroll_page">&nbsp;</div>').appendTo('body');
    var bottom_el = $('#' + options.bottomId);
    if (!bottom_el.length) bottom_el = $('<div id="bottom_scroll_page">&nbsp;</div>').appendTo('body');
    ...
    both_el.on('dragenter', function (e) {
      var direction = $(this).attr('id') == options.topId ? 'up' : 'down'; //console.log('dragenter '+direction);
    ...
    both_el.on('dragover', function (e) {
      ...
      var current = direction == -1 ? scrollTop : $(document).height() - (scrollTop + $(window).height()); //console.log('dragover '+direction+' last='+last+' current='+current);

      if (last != undefined && last == current && current > 0) {
        var newScrollTop = scrollTop + direction * 50; //console.log('scrolling '+newScrollTop);

        $('html,body').animate({
          scrollTop: newScrollTop
        }, options.delay, 'linear');
      }
    ...
    $(document).on('drop', _hide); // In IE dragend does not always get triggered.
...
},{}]},{},["node_modules/parcel/src/builtins/hmr-runtime.js","javascript/lib/jquery.dnd_page_scroll.js"], null)
//# sourceMappingURL=/jquery.dnd_page_scroll.cdc9b37f.js.map